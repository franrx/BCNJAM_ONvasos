...
public class PuntoVerdeParser extends DefaultHandler{
    ...
    public void endElement(String namespaceURI, String localName, String qName) throws SAXException {
    	if(localName.equals("identifier"))
    		PuntoVerdeActual.setIdentifier(sb.toString().replace("\n", "").trim());
    	else if(localName.equals("fn"))
    		PuntoVerdeActual.setDescription(sb.toString().replace("\n", "").trim());
    	else if(localName.equals("district"))
    		PuntoVerdeActual.setDistrict(sb.toString().replace("\n", "").trim());
    	else if(localName.equals("neighborhood"))
    		PuntoVerdeActual.setNeighborhood(sb.toString().replace("\n", "").trim());
    	else if(localName.equals("postal-code"))
    		PuntoVerdeActual.setPostalCode(sb.toString().replace("\n", "").trim());
    	else if(localName.equals("locality"))
    		PuntoVerdeActual.setLocality(sb.toString().replace("\n", "").trim());
    	else if(localName.equals("region"))
    		PuntoVerdeActual.setRegion(sb.toString().replace("\n", "").trim());
    	else if(localName.equals("country-name"))
    		PuntoVerdeActual.setCountry(sb.toString().replace("\n", "").trim());
    	else if(localName.equals("latitude"))
    		PuntoVerdeActual.setLatitude(sb.toString().replace("\n", "").trim());
    	else if(localName.equals("longitude"))
    		PuntoVerdeActual.setLongitude(sb.toString().replace("\n", "").trim());
    	else if(localName.equals("schedule"))
    		PuntoVerdeActual.setSchedule(sb.toString().replace("\n", "").trim());
    	else if(localName.equals("label"))
    		PuntoVerdeActual.setLabel(sb.toString().replace("\n", "").trim());
    	else if(localName.equals("value"))
    		PuntoVerdeActual.setValue(sb.toString().replace("\n", "").trim());
